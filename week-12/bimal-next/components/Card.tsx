  ...
  return (
    <div className="group w-full h-full bg-orange-100 rounded-2xl flex flex-col md:flex-row items-center justify-center p-6 gap-12">
      <Image
        ...
        width={270}
        height={270}
        className="group-hover: translate-y-1 transition-all duraction-300 object-contain"
      />
      <div className="flex flex-col gap-6">
        <div className="flex flex-col text-orange-950">
          <h3 className="lg:text-2xl md:text-xl font-semibold tracking-tighter">
        ...
        <div className="flex items-center gap-2">
          ...
          <button className="bg-orange-50 text-orange-950 px-4 py-2 rounded-lg hover:bg-orange-50/50 transition-all duraction-300">
            Die Later
          </button>
        </div>
      </div>
