...
const Footer = () => {
  return (
    <footer className="py-4 px-4 flex items-center justify-center flex-col gap-4">
      <div className="flex flex-col items-center justify-center gap-2 mex-w-sm">
        <Link href="/">
          <h1 className="text-2xl font-extrabold text-orange-50 tracking-tighter hover:text-orange-700 transition-all duraction-300">
            bimal
          </h1>
        </Link>
